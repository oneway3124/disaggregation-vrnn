...
from redd_utils import fetch_redd


class Redd(TemporalSeries, SequentialPrepMixin): #TemporalSeries comes from class Data (in cle/cle/data/init) and it has ITERATOR
    """
    ...
    def __init__(self, prep='none', cond=False, X_mean=None, X_std=None,
                 bias=None, period=6, n_steps=1000, x_dim = 1,stride_train = 100,stride_test=1000,  **kwargs):
        ...
        super(Redd, self).__init__(**kwargs)
