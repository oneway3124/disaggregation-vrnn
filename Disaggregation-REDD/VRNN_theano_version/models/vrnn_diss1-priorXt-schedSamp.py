...
windows = {'train': {1: ("2011-04-18", "2011-05-05")}, 'test':{1:("2011-05-05", "2011-05-14")}, 'val':{1:("2011-05-14", "2011-05-25")}}
...
def main(args):
    ...
    model = Model()
    Xtrain, ytrain, Xval, yval, Xtest, ytest, reader = fetch_redd(data_path, windows, appliances,numApps=flgAgg, period=period,
    ...
    print(reader.meanTraining, reader.stdTraining)
