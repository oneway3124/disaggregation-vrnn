...
windows = {1:("2014-02-01", "2016-02-01")}#, 2:("2013-02-27", "2013-04-27")
...
def main(args):
    ...
    for i , item in enumerate(mainloop.trainlog.monitor['nll_upper_bound']):
      ...
      j = mainloop.trainlog.monitor['mae1'][i]
      k = mainloop.trainlog.monitor['mae2'][i]
      l = mainloop.trainlog.monitor['mae3'][i]
      m = mainloop.trainlog.monitor['mae4'][i]
      n = mainloop.trainlog.monitor['mae5'][i]
      fLog.write("{},{},{},{},{},{},{},{},{},{},{},{},{},{}\n".format(ep,a,b,c,d,e,f,g,h,j,k,l,m,n))
