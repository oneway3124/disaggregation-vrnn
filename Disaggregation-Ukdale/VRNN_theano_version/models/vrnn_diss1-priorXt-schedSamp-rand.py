...
def main(args):
    ...
    ss_mask  = T.shared_randomstreams.RandomStreams(np.random.randint(999999))
    ...
    scheduleSamplingMask = ss_mask.binomial(n=1,p=kSchedSamp,size=(n_steps,))
    ...
    test_fn = theano.function(inputs=[x, y],#[x, y],
                              ...
                              outputs=[z_t_temp_val, s_temp_val, theta_mu_temp_val, prediction_val, recon_term_val, mse_val, mae_val, relErr_val,propAssigned_val ]#prediction_val, mse_val, mae_val
    ...
    for batch in data:
      ...
      testOutput.append(outputGeneration[4:7])
      testMetrics2.append(outputGeneration[7:])
      #{0:[4,20], 2:[5,10]} 
      #if (numBatchTest==0):
      '''
      plt.figure(1)
