...
## it's ok to use most of the data for training
windows = {'train': {1: ("2013-02-27", "2017-02-27")}, 'test':{1:("2017-02-27", "2017-03-27")}, 'val':{1:("2017-03-27", "2017-04-27")}}
...
def main(args):
    ...
    instancesPlot = {0:[4]} #for now use hard coded instancesPlot for kelly sampling
