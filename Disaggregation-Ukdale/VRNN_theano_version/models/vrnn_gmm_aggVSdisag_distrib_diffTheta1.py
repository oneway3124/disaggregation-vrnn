...
def main(args):
    ...
    nodes = [rnn,
             ...
             theta_1, theta_mu1, theta_mu2, theta_sig1, theta_sig2, coeff1, coeff2]#, corr, binary
    ...
    recon = GMMdisag(y_in, theta_mu1_in, theta_sig1_in, coeff1_in, theta_mu2_in, theta_sig2_in, coeff2_in)# BiGMM(x_in, theta_mu_in, theta_sig_in, coeff_in, corr_in, binary_in)
    ...
    extension = [
        ...
        Monitoring(freq=monitoring_freq,
                   ddout=[nll_upper_bound, recon_term, kl_term,
                          theta_mu1_temp, theta_sig1_temp,theta_mu2_temp, theta_sig2_temp, 
                          z_t_temp,y_pred1_temp,y_pred2_temp,#corr_temp, binary_temp, 
                          coeff1_temp,coeff2_temp, #22
                          s_temp, z_1_temp],
                   indexSep=3,
                   indexDDoutPlot = [(0,theta_mu1_temp), (2,theta_mu2_temp), (4, z_t_temp), (5,y_pred1_temp), (6,y_pred2_temp)], # adding indexes of ddout for the plotting
                   instancesPlot = [50, 120],#0-150
...
if __name__ == "__main__":
    ...
    params['save_path'] = params['save_path']+'/aggVSdisag_distrib_diffThe1/'+datetime.datetime.now().strftime("%y-%m-%d_%H-%M")
