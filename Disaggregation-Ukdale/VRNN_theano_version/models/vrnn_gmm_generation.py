...
windows = {1:("2013-02-27", "2016-02-27")}#, 2:("2013-02-27", "2013-04-27")
listDates = ['2013-08-26 07:57','2014-11-15 00:00','2015-11-15 09:28','2015-12-15 07:25']

'''kettle
2015-11-15 09:28:12+00:00 
2015-12-15 07:25:36+00:00
'''
def main(args):
    ...
    instancesPlot = {0:[10,20], 2:[20,30]} #for now use hard coded instancesPlot for kelly sampling
    if(not loadAsKelly):
