...
windows = {1:("2014-02-01", "2017-02-01")}#, 2:("2013-02-27", "2013-04-27")
#2014-2017: 50000
...
def main(args):
    ...
    mse2_val = T.zeros((y.shape[0],y.shape[1],1))
    mae2_val = T.zeros((y.shape[0],y.shape[1],1))
    mse3_val = T.zeros((y.shape[0],y.shape[1],1))
    mae3_val = T.zeros((y.shape[0],y.shape[1],1))
    mse4_val = T.zeros((y.shape[0],y.shape[1],1))
    mae4_val = T.zeros((y.shape[0],y.shape[1],1))
    mse5_val = T.zeros((y.shape[0],y.shape[1],1))
    mae5_val = T.zeros((y.shape[0],y.shape[1],1))
    ...
    mae1_test = this_mean = testOutput[:, 4].mean()
    mse2_test = this_mean = testOutput[:, 5].mean()
    mae2_test = this_mean = testOutput[:, 6].mean()
    mse3_test = this_mean = testOutput[:, 7].mean()
    mae3_test = this_mean = testOutput[:, 8].mean()
    mse4_test = this_mean = testOutput[:, 9].mean()
    mae4_test = this_mean = testOutput[:, 10].mean()
    mse5_test = this_mean = testOutput[:, 11].mean()
    mae5_test = this_mean = testOutput[:, 12].mean()
